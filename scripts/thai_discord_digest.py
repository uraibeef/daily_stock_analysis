...
3. โครงสร้าง:
   ...
   **หุ้นรายตัว** — เรียงคะแนนมาก→น้อย รูปแบบต่อตัว (กระชับ ตัวละ ~5 บรรทัด):
   [emoji] **TICKER** — $XXX.XX (▲/▼X.X% วันนี้) · คะแนน XX/100 · [คำแนะนำไทย]
   ...
   ราคา + % วันนี้: เอาจากตาราง Market Snapshot ของแต่ละตัว (ช่อง Close และ Change %) — ใช้ ▲ ถ้าบวก ▼ ถ้าลบ ตัวเลขตรงตามรายงานเป๊ะ
